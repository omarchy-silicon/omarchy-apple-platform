...
| P-07 | omarchy-mac | Retire legacy in-place conversion or implement it as a separately approved journaled migration with preserved recovery root and crash-safe boot commit | P-05, P-06 | IN PROGRESS |
...
| 2026-09-03 | P-05 fail-closed platform update routing merged | status transition: P-05 from TODO to IN PROGRESS; product PR #7 https://github.com/omarchy-silicon/omarchy-mac/pull/7 merged final reviewed head `8c54af610a66f333f30e0b28618d4155e847eac0` to `quattro` as `bbffd31510dc769dc31f787a338bc8489d988445`; exact PR workflow `33748669411` and exact post-merge workflow `33748738799` passed | The product now exposes one closed `status`/`apply`/`rollback` UX, routes aarch64 updates before logging or mutation through the exact installed product root, and blocks independent channels, direct update leaves, sourced helpers, and caller-forged pacman authorization; the production authority adapter, journaled executor, snapshot and rollback execution, boot-health fallback, qualification, stable promotion, support, release, and terminal completion remain open |
| 2026-09-03 | P-07 legacy conversion runtime retired | status transition: P-07 from TODO to IN PROGRESS; product PR #8 https://github.com/omarchy-silicon/omarchy-mac/pull/8 merged final reviewed head `512dda030c4986ba2e4059f60a94f958daa9ea69` to `quattro` as `970a098be95dd0b83251f29e66bbeb7d8851aa4c`; exact PR workflow `33750344350` and exact post-merge workflow `33750415971` passed | The three unsupported standalone conversion entrypoints now fail closed as hidden non-mutating tombstones, runnable legacy instructions and obsolete implementation suites are removed, and Apple package staging continues to omit them; historical installed residue handling, native recovery, journaled provisioning, physical qualification, support, promotion, release, and terminal completion remain open |
