...
This checkout is the executable F-02 implementation increment. It provides a bounded Python 3.12 JSON transport parser, eight closed Draft 2020-12 type schemas, immutable typed payload views, RFC 8785 canonical bytes, domain-separated SHA-256 helpers, pure cross-document conformance admission, a read-only diagnostic CLI, accepted fixtures, hostile boundary tests, and schema-lock drift checking. Conformance is deliberately unsigned and untrusted.
